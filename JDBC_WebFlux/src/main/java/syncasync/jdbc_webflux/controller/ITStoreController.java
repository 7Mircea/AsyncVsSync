package syncasync.jdbc_webflux.controller;
...
import syncasync.jdbc_webflux.model.*;
import syncasync.jdbc_webflux.repository.*;
...
public class ITStoreController {
    ...
    public Iterable<Product> getFirstNProducts(@RequestParam int N) {
