...
import syncasync.r2dbc_webflux.model.Product;
import syncasync.r2dbc_webflux.model.custom_query_return.CategoryProductProfit;
import syncasync.r2dbc_webflux.model.custom_query_return.CategoryProfit;
import org.springframework.data.r2dbc.repository.Query;
import org.springframework.data.r2dbc.repository.R2dbcRepository;
import reactor.core.publisher.Flux;

public interface ProductsRepository extends R2dbcRepository<Product, Integer> {
    @Query(value = "select distinct SS.category category, SS.Product_name, SS.Profit\n" +
    ...
    Flux<Product> findProductsByIdProdIsBefore(int N);
}
